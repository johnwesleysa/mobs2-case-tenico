# Painel de Veículos MOBS2 - Case Técnico

## Visão Geral
Este projeto é uma aplicação full-stack desenvolvida como parte de um case técnico para a MOBS2. O objetivo é criar um painel para visualização de veículos de uma frota no mapa, com dados de telemetria e histórico de posições.
